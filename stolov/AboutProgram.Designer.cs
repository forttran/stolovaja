namespace stolov {
	partial class AboutProgram {
		...
		private void InitializeComponent() {
			...
			this.label1.Text = "Программа для приема заказов в столовой.";
			// 
			// label2
			// 
			...
			this.label2.Text = "Автор: Васильев Сергей";
			// 
			// label3
			// 
			...
			this.label3.Text = "email: forttran@mail.ru";
			// 
			// label4
			// 
